...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_jobs_sifen_consulta_lote
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_comprobantes_ruc_numero
  ON comprobantes (tenant_id, ruc_vendedor, numero_comprobante);

-- Composite index for anomaly monto/frecuencia queries
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_comprobantes_ruc_fecha
